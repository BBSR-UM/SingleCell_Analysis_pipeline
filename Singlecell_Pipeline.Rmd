...
```{r}
GSE146771_CRC_Leukocyte_10x_Metadata<- read.csv("/data/GSE146771_CRC.Leukocyte.10x.Metadata.txt", sep = "\t")
...
GSE146771_CRC_Leukocyte_10x_TPM<-readRDS("/data/GSE146771_CRC_Leukocyte_10x_TPM.rds")
```
